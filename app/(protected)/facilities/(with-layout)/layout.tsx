...
function FacilitiesLayoutContent({ children }: FacilitiesLayoutProps) {
  const router = useRouter();
  const pathname = usePathname();
  const { headerState } = useFacilitiesPageHeader();
  ...
  const tabs = useMemo(() => [
    ...
    },
    {
      ...
      active: pathname.startsWith('/facilities/requests') && !pathname.includes('/requests/'),
    },
  ], [pathname]);
...
export default function FacilitiesLayout({ children }: FacilitiesLayoutProps) {
  return (
    <FacilitiesPageHeaderProvider>
      <FacilitiesLayoutContent>
        {children}
      </FacilitiesLayoutContent>
    </FacilitiesPageHeaderProvider>
  );
