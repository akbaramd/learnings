    ...
    <>
      ...
      <div className="h-full flex flex-col" dir="rtl">
        ...
        <div className="flex-1 flex flex-row overflow-hidden relative">
          ...
          <div className="flex-shrink-0 w-12  self-start top-0 py-4  h-full">
            <div className="bg-white dark:bg-gray-900 border-l border-t border-b border-gray-200 dark:border-gray-800  rounded-tl-lg rounded-bl-lg overflow-hidden flex flex-col items-center gap-2 h-full">
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`tab-item relative w-full min-h-[90px] flex flex-col items-center justify-center gap-2 py-2 transition-all first:rounded-tl-sm ${
                      isActive
