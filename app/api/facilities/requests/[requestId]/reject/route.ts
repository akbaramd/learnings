...
import { RejectFacilityRequestResponse } from '@/src/store/facilities/facilities.types';
import { AxiosError } from 'axios';

/**
 * POST /api/facilities/requests/[requestId]/reject
...
export async function POST(
  ...
  try {
    ...
    const response: RejectFacilityRequestResponse = {
    ...
    console.error('[Facilities] Reject Request BFF error:', {
