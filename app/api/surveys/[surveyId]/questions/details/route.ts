...
import { GetSurveyQuestionsDetailsResponse } from '@/src/store/surveys/surveys.types';
import { AxiosError } from 'axios';

/**
 * GET /api/surveys/[surveyId]/questions/details
...
export async function GET(
  ...
  try {
    ...
    const upstream = await api.api.getSurveyQuestionsDetails(surveyId, {
      includeUserAnswers,
      includeStatistics,
    }, {});
    ...
    const response: GetSurveyQuestionsDetailsResponse = {
