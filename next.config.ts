      ...
      },
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://widget.raychat.io",
              "style-src 'self' 'unsafe-inline' https://widget.raychat.io",
              "img-src 'self' data: https:",
              "connect-src 'self' https: https://widget.raychat.io",
              "font-src 'self' data: https:",
              "frame-src 'self' https://widget.raychat.io",
