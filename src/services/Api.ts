...
export enum FacilityRequestStatus {
  ...
  Waitlisted = "Waitlisted",
  ReturnedForAmendment = "ReturnedForAmendment",
  ...
  BankScheduled = "BankScheduled",
  ProcessedByBank = "ProcessedByBank",
  Completed = "Completed",
  Disbursed = "Disbursed",
  Expired = "Expired",
...
export interface FacilityRequestDetailsDto {
  ...
  rejectionReasonDetails?: RejectionReasonDto;
...
export interface GetRejectionReasonsResult {
  rejectionReasons?: RejectionReasonDto[] | null;
}

export interface GetRejectionReasonsResultApplicationResult {
  isSuccess?: boolean;
  status?: ResultStatus;
  message?: string | null;
  errors?: string[] | null;
  data?: GetRejectionReasonsResult;
}
...
export interface MemberDetailDto {
  ...
  capabilityList?: NamedValueDto[] | null;
  featureList?: NamedValueDto[] | null;
  agencyList?: MemberAgencySummaryDto[] | null;
  /** @format date-time */
...
export interface RequestDocumentsResultApplicationResult {
  isSuccess?: boolean;
  status?: ResultStatus;
  message?: string | null;
  errors?: string[] | null;
  data?: RequestDocumentsResult;
}
...
export interface StartReviewResultApplicationResult {
  isSuccess?: boolean;
  status?: ResultStatus;
  message?: string | null;
  errors?: string[] | null;
  data?: StartReviewResult;
}
...
> extends HttpClient<SecurityDataType> {
  api = {
     ...
     * @request POST:/api/v1/auth/logout/refresh-token
     * @secure
     */
    logoutByRefreshToken: (
      data: LogoutByRefreshTokenRequest,
      ...
      >({
        path: `/api/v1/auth/logout/refresh-token`,
        method: "POST",
        body: data,
        secure: true,
        type: ContentType.Json,
     ...
     * @request POST:/api/v1/auth/logout/session/{sessionId}
     * @secure
     */
    logoutBySessionId: (
      sessionId: string,
      ...
      >({
        path: `/api/v1/auth/logout/session/${sessionId}`,
        method: "POST",
        body: data,
        secure: true,
        format: "json",
     ...
     * @secure
     */
    logoutAllSessions: (data: any, params: RequestParams = {}) =>
      this.request<
        LogoutResponseApplicationResult,
        | LogoutResponseApplicationResult
        | {
     ...
     * @request POST:/api/v1/auth/logout/others
     * @secure
     */
    logoutAllOtherSessions: (data: any, params: RequestParams = {}) =>
      this.request<
        LogoutResponseApplicationResult,
        | LogoutResponseApplicationResult
        | {
      ...
      >({
        path: `/api/v1/auth/logout/others`,
        method: "POST",
        body: data,
        secure: true,
        format: "json",
    ...
    getRejectionReasons: (
      ...
      this.request<
        GetRejectionReasonsResultApplicationResult,
        void | {
          /** @example "internal_server_error" */
          error?: string;
          /** @example "خطای داخلی سرور رخ داده است" */
      ...
      >({
        path: `/api/v1/facilities/rejection-reasons`,
        method: "GET",
        query: query,
        format: "json",
        ...params,
     ...
     * @request GET:/api/v1/membership/members/me
     * @secure
     */
    getCurrentMember: (data: any, params: RequestParams = {}) =>
      ...
      >({
        path: `/api/v1/membership/members/me`,
        method: "GET",
        body: data,
        secure: true,
        format: "json",
     ...
     * @summary Synchronize current member with external source
     * @request POST:/api/v1/membership/members/me/sync
     * @secure
     */
    syncCurrentMember: (data: any, params: RequestParams = {}) =>
      ...
      >({
        path: `/api/v1/membership/members/me/sync`,
        method: "POST",
        body: data,
        secure: true,
        format: "json",
